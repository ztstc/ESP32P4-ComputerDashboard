...
typedef struct _WifiInitConfig WifiInitConfig;
typedef struct _WifiCountry WifiCountry;
typedef struct _WifiActiveScanTime WifiActiveScanTime;
typedef struct _WifiScanTime WifiScanTime;
typedef struct _WifiScanChannelBitmap WifiScanChannelBitmap;
typedef struct _WifiScanConfig WifiScanConfig;
...
typedef struct _WifiBssMaxIdleConfig WifiBssMaxIdleConfig;
...
typedef struct _WifiStaInfo WifiStaInfo;
typedef struct _WifiStaList WifiStaList;
typedef struct _WifiPktRxCtrl WifiPktRxCtrl;
typedef struct _WifiPromiscuousPkt WifiPromiscuousPkt;
typedef struct _WifiPromiscuousFilter WifiPromiscuousFilter;
typedef struct _WifiCsiConfig WifiCsiConfig;
typedef struct _WifiCsiInfo WifiCsiInfo;
typedef struct _WifiAntGpio WifiAntGpio;
typedef struct _WifiAntGpioConfig WifiAntGpioConfig;
typedef struct _WifiAntConfig WifiAntConfig;
typedef struct _WifiActionTxReq WifiActionTxReq;
typedef struct _WifiFtmInitiatorCfg WifiFtmInitiatorCfg;
typedef struct _WifiEventStaScanDone WifiEventStaScanDone;
typedef struct _WifiEventStaConnected WifiEventStaConnected;
typedef struct _WifiEventStaDisconnected WifiEventStaDisconnected;
typedef struct _WifiEventStaAuthmodeChange WifiEventStaAuthmodeChange;
typedef struct _WifiEventStaWpsErPin WifiEventStaWpsErPin;
typedef struct _ApCred ApCred;
typedef struct _WifiEventStaWpsErSuccess WifiEventStaWpsErSuccess;
typedef struct _WifiEventApProbeReqRx WifiEventApProbeReqRx;
typedef struct _WifiEventBssRssiLow WifiEventBssRssiLow;
typedef struct _WifiFtmReportEntry WifiFtmReportEntry;
typedef struct _WifiEventFtmReport WifiEventFtmReport;
typedef struct _WifiEventActionTxStatus WifiEventActionTxStatus;
typedef struct _WifiEventRocDone WifiEventRocDone;
typedef struct _WifiEventApWpsRgPin WifiEventApWpsRgPin;
typedef struct _WifiEventApWpsRgFailReason WifiEventApWpsRgFailReason;
typedef struct _WifiEventApWpsRgSuccess WifiEventApWpsRgSuccess;
typedef struct _WifiProtocols WifiProtocols;
typedef struct _WifiBandwidths WifiBandwidths;
typedef struct _WifiItwtSetupConfig WifiItwtSetupConfig;
typedef struct _WifiTwtConfig WifiTwtConfig;
typedef struct _ConnectedSTAList ConnectedSTAList;
typedef struct _EapFastConfig EapFastConfig;
typedef struct _RpcReqGetMacAddress RpcReqGetMacAddress;
typedef struct _RpcRespGetMacAddress RpcRespGetMacAddress;
typedef struct _RpcReqGetMode RpcReqGetMode;
typedef struct _RpcRespGetMode RpcRespGetMode;
typedef struct _RpcReqSetMode RpcReqSetMode;
typedef struct _RpcRespSetMode RpcRespSetMode;
typedef struct _RpcReqGetPs RpcReqGetPs;
typedef struct _RpcRespGetPs RpcRespGetPs;
typedef struct _RpcReqSetPs RpcReqSetPs;
typedef struct _RpcRespSetPs RpcRespSetPs;
typedef struct _RpcReqSetMacAddress RpcReqSetMacAddress;
typedef struct _RpcRespSetMacAddress RpcRespSetMacAddress;
typedef struct _RpcReqOTABegin RpcReqOTABegin;
typedef struct _RpcRespOTABegin RpcRespOTABegin;
typedef struct _RpcReqOTAWrite RpcReqOTAWrite;
typedef struct _RpcRespOTAWrite RpcRespOTAWrite;
typedef struct _RpcReqOTAEnd RpcReqOTAEnd;
typedef struct _RpcRespOTAEnd RpcRespOTAEnd;
typedef struct _RpcReqWifiSetMaxTxPower RpcReqWifiSetMaxTxPower;
typedef struct _RpcRespWifiSetMaxTxPower RpcRespWifiSetMaxTxPower;
typedef struct _RpcReqWifiGetMaxTxPower RpcReqWifiGetMaxTxPower;
typedef struct _RpcRespWifiGetMaxTxPower RpcRespWifiGetMaxTxPower;
typedef struct _RpcReqConfigHeartbeat RpcReqConfigHeartbeat;
typedef struct _RpcRespConfigHeartbeat RpcRespConfigHeartbeat;
typedef struct _RpcReqWifiInit RpcReqWifiInit;
typedef struct _RpcRespWifiInit RpcRespWifiInit;
typedef struct _RpcReqWifiDeinit RpcReqWifiDeinit;
typedef struct _RpcRespWifiDeinit RpcRespWifiDeinit;
typedef struct _RpcReqWifiSetConfig RpcReqWifiSetConfig;
typedef struct _RpcRespWifiSetConfig RpcRespWifiSetConfig;
typedef struct _RpcReqWifiGetConfig RpcReqWifiGetConfig;
typedef struct _RpcRespWifiGetConfig RpcRespWifiGetConfig;
typedef struct _RpcReqWifiConnect RpcReqWifiConnect;
typedef struct _RpcRespWifiConnect RpcRespWifiConnect;
typedef struct _RpcReqWifiDisconnect RpcReqWifiDisconnect;
typedef struct _RpcRespWifiDisconnect RpcRespWifiDisconnect;
typedef struct _RpcReqWifiStart RpcReqWifiStart;
typedef struct _RpcRespWifiStart RpcRespWifiStart;
typedef struct _RpcReqWifiStop RpcReqWifiStop;
typedef struct _RpcRespWifiStop RpcRespWifiStop;
typedef struct _RpcReqWifiScanStart RpcReqWifiScanStart;
typedef struct _RpcRespWifiScanStart RpcRespWifiScanStart;
typedef struct _RpcReqWifiScanStop RpcReqWifiScanStop;
typedef struct _RpcRespWifiScanStop RpcRespWifiScanStop;
typedef struct _RpcReqWifiScanGetApNum RpcReqWifiScanGetApNum;
typedef struct _RpcRespWifiScanGetApNum RpcRespWifiScanGetApNum;
typedef struct _RpcReqWifiScanGetApRecords RpcReqWifiScanGetApRecords;
typedef struct _RpcRespWifiScanGetApRecords RpcRespWifiScanGetApRecords;
typedef struct _RpcReqWifiScanGetApRecord RpcReqWifiScanGetApRecord;
typedef struct _RpcRespWifiScanGetApRecord RpcRespWifiScanGetApRecord;
typedef struct _RpcReqWifiClearApList RpcReqWifiClearApList;
typedef struct _RpcRespWifiClearApList RpcRespWifiClearApList;
typedef struct _RpcReqWifiRestore RpcReqWifiRestore;
typedef struct _RpcRespWifiRestore RpcRespWifiRestore;
typedef struct _RpcReqWifiClearFastConnect RpcReqWifiClearFastConnect;
typedef struct _RpcRespWifiClearFastConnect RpcRespWifiClearFastConnect;
typedef struct _RpcReqWifiDeauthSta RpcReqWifiDeauthSta;
typedef struct _RpcRespWifiDeauthSta RpcRespWifiDeauthSta;
typedef struct _RpcReqWifiStaGetApInfo RpcReqWifiStaGetApInfo;
typedef struct _RpcRespWifiStaGetApInfo RpcRespWifiStaGetApInfo;
typedef struct _RpcReqWifiSetProtocol RpcReqWifiSetProtocol;
typedef struct _RpcRespWifiSetProtocol RpcRespWifiSetProtocol;
typedef struct _RpcReqWifiGetProtocol RpcReqWifiGetProtocol;
typedef struct _RpcRespWifiGetProtocol RpcRespWifiGetProtocol;
typedef struct _RpcReqWifiSetBandwidth RpcReqWifiSetBandwidth;
typedef struct _RpcRespWifiSetBandwidth RpcRespWifiSetBandwidth;
typedef struct _RpcReqWifiGetBandwidth RpcReqWifiGetBandwidth;
typedef struct _RpcRespWifiGetBandwidth RpcRespWifiGetBandwidth;
typedef struct _RpcReqWifiSetChannel RpcReqWifiSetChannel;
typedef struct _RpcRespWifiSetChannel RpcRespWifiSetChannel;
typedef struct _RpcReqWifiGetChannel RpcReqWifiGetChannel;
typedef struct _RpcRespWifiGetChannel RpcRespWifiGetChannel;
typedef struct _RpcReqWifiSetStorage RpcReqWifiSetStorage;
typedef struct _RpcRespWifiSetStorage RpcRespWifiSetStorage;
typedef struct _RpcReqWifiSetCountryCode RpcReqWifiSetCountryCode;
typedef struct _RpcRespWifiSetCountryCode RpcRespWifiSetCountryCode;
typedef struct _RpcReqWifiGetCountryCode RpcReqWifiGetCountryCode;
typedef struct _RpcRespWifiGetCountryCode RpcRespWifiGetCountryCode;
typedef struct _RpcReqWifiSetCountry RpcReqWifiSetCountry;
typedef struct _RpcRespWifiSetCountry RpcRespWifiSetCountry;
typedef struct _RpcReqWifiGetCountry RpcReqWifiGetCountry;
typedef struct _RpcRespWifiGetCountry RpcRespWifiGetCountry;
typedef struct _RpcReqWifiApGetStaList RpcReqWifiApGetStaList;
typedef struct _RpcRespWifiApGetStaList RpcRespWifiApGetStaList;
typedef struct _RpcReqWifiApGetStaAid RpcReqWifiApGetStaAid;
typedef struct _RpcReqWifiStaGetNegotiatedPhymode RpcReqWifiStaGetNegotiatedPhymode;
typedef struct _RpcRespWifiStaGetNegotiatedPhymode RpcRespWifiStaGetNegotiatedPhymode;
typedef struct _RpcRespWifiApGetStaAid RpcRespWifiApGetStaAid;
typedef struct _RpcReqWifiStaGetRssi RpcReqWifiStaGetRssi;
typedef struct _RpcRespWifiStaGetRssi RpcRespWifiStaGetRssi;
typedef struct _RpcReqWifiStaGetAid RpcReqWifiStaGetAid;
typedef struct _RpcRespWifiStaGetAid RpcRespWifiStaGetAid;
typedef struct _RpcReqWifiSetProtocols RpcReqWifiSetProtocols;
typedef struct _RpcRespWifiSetProtocols RpcRespWifiSetProtocols;
typedef struct _RpcReqWifiGetProtocols RpcReqWifiGetProtocols;
typedef struct _RpcRespWifiGetProtocols RpcRespWifiGetProtocols;
typedef struct _RpcReqWifiSetBandwidths RpcReqWifiSetBandwidths;
typedef struct _RpcRespWifiSetBandwidths RpcRespWifiSetBandwidths;
typedef struct _RpcReqWifiGetBandwidths RpcReqWifiGetBandwidths;
typedef struct _RpcRespWifiGetBandwidths RpcRespWifiGetBandwidths;
typedef struct _RpcReqWifiSetBand RpcReqWifiSetBand;
typedef struct _RpcRespWifiSetBand RpcRespWifiSetBand;
typedef struct _RpcReqWifiGetBand RpcReqWifiGetBand;
typedef struct _RpcRespWifiGetBand RpcRespWifiGetBand;
typedef struct _RpcReqWifiSetBandMode RpcReqWifiSetBandMode;
typedef struct _RpcRespWifiSetBandMode RpcRespWifiSetBandMode;
typedef struct _RpcReqWifiGetBandMode RpcReqWifiGetBandMode;
typedef struct _RpcRespWifiGetBandMode RpcRespWifiGetBandMode;
typedef struct _RpcReqWifiSetInactiveTime RpcReqWifiSetInactiveTime;
typedef struct _RpcRespWifiSetInactiveTime RpcRespWifiSetInactiveTime;
typedef struct _RpcReqWifiGetInactiveTime RpcReqWifiGetInactiveTime;
typedef struct _RpcRespWifiGetInactiveTime RpcRespWifiGetInactiveTime;
typedef struct _RpcReqWifiStaItwtSetup RpcReqWifiStaItwtSetup;
typedef struct _RpcRespWifiStaItwtSetup RpcRespWifiStaItwtSetup;
typedef struct _RpcReqWifiStaItwtTeardown RpcReqWifiStaItwtTeardown;
typedef struct _RpcRespWifiStaItwtTeardown RpcRespWifiStaItwtTeardown;
typedef struct _RpcReqWifiStaItwtSuspend RpcReqWifiStaItwtSuspend;
typedef struct _RpcRespWifiStaItwtSuspend RpcRespWifiStaItwtSuspend;
typedef struct _RpcReqWifiStaItwtGetFlowIdStatus RpcReqWifiStaItwtGetFlowIdStatus;
typedef struct _RpcRespWifiStaItwtGetFlowIdStatus RpcRespWifiStaItwtGetFlowIdStatus;
typedef struct _RpcReqWifiStaItwtSendProbeReq RpcReqWifiStaItwtSendProbeReq;
typedef struct _RpcRespWifiStaItwtSendProbeReq RpcRespWifiStaItwtSendProbeReq;
typedef struct _RpcReqWifiStaItwtSetTargetWakeTimeOffset RpcReqWifiStaItwtSetTargetWakeTimeOffset;
typedef struct _RpcRespWifiStaItwtSetTargetWakeTimeOffset RpcRespWifiStaItwtSetTargetWakeTimeOffset;
typedef struct _RpcReqWifiStaTwtConfig RpcReqWifiStaTwtConfig;
typedef struct _RpcRespWifiStaTwtConfig RpcRespWifiStaTwtConfig;
typedef struct _RpcReqGetCoprocessorFwVersion RpcReqGetCoprocessorFwVersion;
typedef struct _RpcRespGetCoprocessorFwVersion RpcRespGetCoprocessorFwVersion;
typedef struct _RpcReqSetDhcpDnsStatus RpcReqSetDhcpDnsStatus;
typedef struct _RpcRespSetDhcpDnsStatus RpcRespSetDhcpDnsStatus;
typedef struct _RpcReqGetDhcpDnsStatus RpcReqGetDhcpDnsStatus;
typedef struct _RpcRespGetDhcpDnsStatus RpcRespGetDhcpDnsStatus;
typedef struct _RpcEventWifiEventNoArgs RpcEventWifiEventNoArgs;
typedef struct _RpcEventESPInit RpcEventESPInit;
typedef struct _RpcEventHeartbeat RpcEventHeartbeat;
typedef struct _RpcEventAPStaDisconnected RpcEventAPStaDisconnected;
typedef struct _RpcEventAPStaConnected RpcEventAPStaConnected;
typedef struct _RpcEventStaScanDone RpcEventStaScanDone;
typedef struct _RpcEventStaConnected RpcEventStaConnected;
typedef struct _RpcEventStaDisconnected RpcEventStaDisconnected;
typedef struct _RpcEventDhcpDnsStatus RpcEventDhcpDnsStatus;
typedef struct _RpcEventStaItwtSetup RpcEventStaItwtSetup;
typedef struct _RpcEventStaItwtTeardown RpcEventStaItwtTeardown;
typedef struct _RpcEventStaItwtSuspend RpcEventStaItwtSuspend;
typedef struct _RpcEventStaItwtProbe RpcEventStaItwtProbe;
typedef struct _RpcReqWifiStaEnterpriseEnable RpcReqWifiStaEnterpriseEnable;
typedef struct _RpcRespWifiStaEnterpriseEnable RpcRespWifiStaEnterpriseEnable;
typedef struct _RpcReqWifiStaEnterpriseDisable RpcReqWifiStaEnterpriseDisable;
typedef struct _RpcRespWifiStaEnterpriseDisable RpcRespWifiStaEnterpriseDisable;
typedef struct _RpcReqEapSetIdentity RpcReqEapSetIdentity;
typedef struct _RpcRespEapSetIdentity RpcRespEapSetIdentity;
typedef struct _RpcReqEapClearIdentity RpcReqEapClearIdentity;
typedef struct _RpcRespEapClearIdentity RpcRespEapClearIdentity;
typedef struct _RpcReqEapSetUsername RpcReqEapSetUsername;
typedef struct _RpcRespEapSetUsername RpcRespEapSetUsername;
typedef struct _RpcReqEapClearUsername RpcReqEapClearUsername;
typedef struct _RpcRespEapClearUsername RpcRespEapClearUsername;
typedef struct _RpcReqEapSetPassword RpcReqEapSetPassword;
typedef struct _RpcRespEapSetPassword RpcRespEapSetPassword;
typedef struct _RpcReqEapClearPassword RpcReqEapClearPassword;
typedef struct _RpcRespEapClearPassword RpcRespEapClearPassword;
typedef struct _RpcReqEapSetNewPassword RpcReqEapSetNewPassword;
typedef struct _RpcRespEapSetNewPassword RpcRespEapSetNewPassword;
typedef struct _RpcReqEapClearNewPassword RpcReqEapClearNewPassword;
typedef struct _RpcRespEapClearNewPassword RpcRespEapClearNewPassword;
typedef struct _RpcReqEapSetCaCert RpcReqEapSetCaCert;
typedef struct _RpcRespEapSetCaCert RpcRespEapSetCaCert;
typedef struct _RpcReqEapClearCaCert RpcReqEapClearCaCert;
typedef struct _RpcRespEapClearCaCert RpcRespEapClearCaCert;
typedef struct _RpcReqEapSetCertificateAndKey RpcReqEapSetCertificateAndKey;
typedef struct _RpcRespEapSetCertificateAndKey RpcRespEapSetCertificateAndKey;
typedef struct _RpcReqEapClearCertificateAndKey RpcReqEapClearCertificateAndKey;
typedef struct _RpcRespEapClearCertificateAndKey RpcRespEapClearCertificateAndKey;
typedef struct _RpcReqEapSetDisableTimeCheck RpcReqEapSetDisableTimeCheck;
typedef struct _RpcRespEapSetDisableTimeCheck RpcRespEapSetDisableTimeCheck;
typedef struct _RpcReqEapGetDisableTimeCheck RpcReqEapGetDisableTimeCheck;
typedef struct _RpcRespEapGetDisableTimeCheck RpcRespEapGetDisableTimeCheck;
typedef struct _RpcReqEapSetTtlsPhase2Method RpcReqEapSetTtlsPhase2Method;
typedef struct _RpcRespEapSetTtlsPhase2Method RpcRespEapSetTtlsPhase2Method;
typedef struct _RpcReqEapSetSuiteb192bitCertification RpcReqEapSetSuiteb192bitCertification;
typedef struct _RpcRespEapSetSuiteb192bitCertification RpcRespEapSetSuiteb192bitCertification;
typedef struct _RpcReqEapSetPacFile RpcReqEapSetPacFile;
typedef struct _RpcRespEapSetPacFile RpcRespEapSetPacFile;
typedef struct _RpcReqEapSetFastParams RpcReqEapSetFastParams;
typedef struct _RpcRespEapSetFastParams RpcRespEapSetFastParams;
typedef struct _RpcReqEapUseDefaultCertBundle RpcReqEapUseDefaultCertBundle;
typedef struct _RpcRespEapUseDefaultCertBundle RpcRespEapUseDefaultCertBundle;
typedef struct _RpcReqWifiSetOkcSupport RpcReqWifiSetOkcSupport;
typedef struct _RpcRespWifiSetOkcSupport RpcRespWifiSetOkcSupport;
typedef struct _RpcReqEapSetDomainName RpcReqEapSetDomainName;
typedef struct _RpcRespEapSetDomainName RpcRespEapSetDomainName;
typedef struct _RpcReqEapSetEapMethods RpcReqEapSetEapMethods;
typedef struct _RpcRespEapSetEapMethods RpcRespEapSetEapMethods;
...
struct  _WifiEventStaDisconnected
{
  ProtobufCMessage base;
  /*
...
struct  _WifiEventStaAuthmodeChange
{
  ProtobufCMessage base;
  /*
...
struct  _WifiEventStaWpsErSuccess
{
  ProtobufCMessage base;
  /*
...
struct  _WifiEventActionTxStatus
{
  ProtobufCMessage base;
  /*
   **< WiFi interface to send request to 
...
struct  _WifiEventApWpsRgFailReason
{
  ProtobufCMessage base;
  /*
...
struct  _WifiEventApWpsRgSuccess
{
  ProtobufCMessage base;
  /*
   **< 6bytes Enrollee mac address 
...
struct  _RpcReqWifiSetMaxTxPower
{
  ProtobufCMessage base;
  int32_t power;
};
...
struct  _RpcRespWifiSetMaxTxPower
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiGetMaxTxPower
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiGetMaxTxPower
{
  ProtobufCMessage base;
  int32_t power;
  int32_t resp;
...
struct  _RpcReqWifiScanGetApNum
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiScanGetApNum
{
  ProtobufCMessage base;
  int32_t resp;
  int32_t number;
...
struct  _RpcReqWifiScanGetApRecords
{
  ProtobufCMessage base;
  int32_t number;
};
...
struct  _RpcRespWifiScanGetApRecords
{
  ProtobufCMessage base;
  int32_t resp;
  int32_t number;
...
struct  _RpcReqWifiScanGetApRecord
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiScanGetApRecord
{
  ProtobufCMessage base;
  int32_t resp;
...
struct  _RpcRespWifiClearApList
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiClearFastConnect
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiClearFastConnect
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiStaGetApInfo
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiStaGetApInfo
{
  ProtobufCMessage base;
  int32_t resp;
  WifiApRecord *ap_record;
...
struct  _RpcRespWifiSetProtocol
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcRespWifiGetProtocol
{
  ProtobufCMessage base;
  int32_t resp;
  int32_t protocol_bitmap;
...
struct  _RpcReqWifiSetBandwidth
{
  ProtobufCMessage base;
  int32_t ifx;
  int32_t bw;
...
struct  _RpcReqWifiGetBandwidth
{
  ProtobufCMessage base;
  int32_t ifx;
};
...
struct  _RpcRespWifiGetBandwidth
{
  ProtobufCMessage base;
  int32_t resp;
  int32_t bw;
...
struct  _RpcReqWifiSetCountryCode
{
  ProtobufCMessage base;
...
struct  _RpcRespWifiSetCountryCode
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiGetCountryCode
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiGetCountryCode
{
  ProtobufCMessage base;
  int32_t resp;
  ProtobufCBinaryData country;
...
struct  _RpcReqWifiApGetStaList
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiApGetStaList
{
  ProtobufCMessage base;
  int32_t resp;
...
struct  _RpcReqWifiStaGetNegotiatedPhymode
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiStaGetNegotiatedPhymode
{
  ProtobufCMessage base;
  int32_t resp;
  uint32_t phymode;
...
struct  _RpcReqWifiSetProtocols
{
  ProtobufCMessage base;
  int32_t ifx;
...
struct  _RpcRespWifiSetProtocols
{
  ProtobufCMessage base;
  int32_t resp;
  uint32_t ifx;
...
struct  _RpcReqWifiGetProtocols
{
  ProtobufCMessage base;
  int32_t ifx;
};
...
struct  _RpcReqWifiSetBandwidths
{
  ProtobufCMessage base;
  int32_t ifx;
...
struct  _RpcRespWifiSetBandwidths
{
  ProtobufCMessage base;
  int32_t resp;
  int32_t ifx;
...
struct  _RpcReqWifiGetBandwidths
{
  ProtobufCMessage base;
  int32_t ifx;
};
...
struct  _RpcRespWifiGetBandwidths
{
  ProtobufCMessage base;
  int32_t resp;
  int32_t ifx;
...
struct  _RpcRespWifiGetBandMode
{
  ProtobufCMessage base;
  int32_t resp;
  uint32_t bandmode;
...
struct  _RpcReqWifiSetInactiveTime
{
  ProtobufCMessage base;
  uint32_t ifx;
  uint32_t sec;
...
struct  _RpcRespWifiSetInactiveTime
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiGetInactiveTime
{
  ProtobufCMessage base;
  uint32_t ifx;
};
...
struct  _RpcRespWifiGetInactiveTime
{
  ProtobufCMessage base;
  int32_t resp;
  uint32_t sec;
...
struct  _RpcReqWifiStaItwtSetup
{
  ProtobufCMessage base;
...
struct  _RpcRespWifiStaItwtSetup
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiStaItwtTeardown
{
  ProtobufCMessage base;
  int32_t flow_id;
};
...
struct  _RpcRespWifiStaItwtTeardown
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiStaItwtSuspend
{
  ProtobufCMessage base;
  int32_t flow_id;
...
struct  _RpcRespWifiStaItwtSuspend
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiStaItwtGetFlowIdStatus
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiStaItwtGetFlowIdStatus
{
  ProtobufCMessage base;
  int32_t resp;
...
struct  _RpcRespWifiStaItwtSendProbeReq
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcRespWifiStaItwtSetTargetWakeTimeOffset
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiStaTwtConfig
{
  ProtobufCMessage base;
...
struct  _RpcRespWifiStaTwtConfig
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcRespGetCoprocessorFwVersion
{
  ProtobufCMessage base;
  int32_t resp;
  uint32_t major1;
...
struct  _RpcReqSetDhcpDnsStatus
{
  ProtobufCMessage base;
  int32_t iface;
  int32_t net_link_up;
...
struct  _RpcRespSetDhcpDnsStatus
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqGetDhcpDnsStatus
{
  ProtobufCMessage base;
  int32_t iface;
};
...
struct  _RpcRespGetDhcpDnsStatus
{
  ProtobufCMessage base;
  int32_t iface;
  int32_t net_link_up;
...
struct  _RpcEventWifiEventNoArgs
{
  ProtobufCMessage base;
  int32_t resp;
  int32_t event_id;
...
struct  _RpcEventAPStaDisconnected
{
  ProtobufCMessage base;
  int32_t resp;
  ProtobufCBinaryData mac;
...
struct  _RpcEventAPStaConnected
{
  ProtobufCMessage base;
  int32_t resp;
  ProtobufCBinaryData mac;
...
struct  _RpcEventStaDisconnected
{
  ProtobufCMessage base;
  int32_t resp;
...
struct  _RpcEventStaItwtTeardown
{
  ProtobufCMessage base;
  int32_t resp;
  uint32_t flow_id;
...
struct  _RpcEventStaItwtSuspend
{
  ProtobufCMessage base;
  int32_t resp;
  int32_t status;
...
struct  _RpcReqWifiStaEnterpriseEnable
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiStaEnterpriseEnable
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiStaEnterpriseDisable
{
  ProtobufCMessage base;
};
...
struct  _RpcRespWifiStaEnterpriseDisable
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapClearIdentity
{
  ProtobufCMessage base;
};
...
struct  _RpcRespEapClearIdentity
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapClearUsername
{
  ProtobufCMessage base;
};
...
struct  _RpcRespEapClearUsername
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapClearPassword
{
  ProtobufCMessage base;
};
...
struct  _RpcRespEapClearPassword
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapSetNewPassword
{
  ProtobufCMessage base;
...
struct  _RpcRespEapSetNewPassword
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapClearNewPassword
{
  ProtobufCMessage base;
};
...
struct  _RpcRespEapClearNewPassword
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapSetCertificateAndKey
{
  ProtobufCMessage base;
...
struct  _RpcRespEapSetCertificateAndKey
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapClearCertificateAndKey
{
  ProtobufCMessage base;
};
...
struct  _RpcReqEapSetDisableTimeCheck
{
  ProtobufCMessage base;
...
struct  _RpcRespEapSetDisableTimeCheck
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapGetDisableTimeCheck
{
  ProtobufCMessage base;
};
...
struct  _RpcReqEapSetTtlsPhase2Method
{
  ProtobufCMessage base;
  int32_t type;
};
...
struct  _RpcRespEapSetTtlsPhase2Method
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapSetSuiteb192bitCertification
{
  ProtobufCMessage base;
  protobuf_c_boolean enable;
};
...
struct  _RpcRespEapSetSuiteb192bitCertification
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapSetFastParams
{
  ProtobufCMessage base;
...
struct  _RpcRespEapSetFastParams
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapUseDefaultCertBundle
{
  ProtobufCMessage base;
...
struct  _RpcRespEapUseDefaultCertBundle
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqWifiSetOkcSupport
{
  ProtobufCMessage base;
  protobuf_c_boolean enable;
};
...
struct  _RpcRespWifiSetOkcSupport
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapSetDomainName
{
  ProtobufCMessage base;
...
struct  _RpcRespEapSetDomainName
{
  ProtobufCMessage base;
  int32_t resp;
};
...
struct  _RpcReqEapSetEapMethods
{
  ProtobufCMessage base;
  int32_t methods;
};
...
struct  _RpcRespEapSetEapMethods
{
  ProtobufCMessage base;
  int32_t resp;
};
...
typedef enum {
  ...
  RPC__PAYLOAD_EVENT_STA_ITWT_PROBE = 781
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(RPC__PAYLOAD)
} Rpc__PayloadCase;
